        ...
        n.define(
          ...
          (t.exports = function (t) {
            var e,
              ...
              v = !1;
            function g() {
              if (((r = l && n.env("design")), !!(e = u.find(d)).length))
                e.each(y),
            ...
            (i.ready = i.design = i.preview = g),
              ...
              (i.destroy = function () {
                if (!!(e = u.find(d)).length) e.each(m), w();
              });
            function m(e, r) {
              var n = t.data(r, d);
              if (!!n)
            ...
            function k(e, r) {
              ...
              if (c !== e.current) {
                ...
                w.length && i.outro
                  ? (w.each(h.outro),
                    o(w)
                      .add("opacity " + i.outro + "ms " + u, { fallback: s })
                      .start({ opacity: 0 })
                      .then(() => O(i, w, g)))
                  : O(i, w, g);
              }
    ...
    (() => {
      ...
      r.O = function (e, n, a, i) {
        ...
        for (var u = 1 / 0, o = 0; o < t.length; o++) {
          for (
            var n = t[o][0], a = t[o][1], i = t[o][2], c = !0, s = 0;
            s < n.length;
            s++
          )
            (!1 & i || u >= i) &&
